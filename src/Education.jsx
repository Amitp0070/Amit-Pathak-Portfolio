...
import { Briefcase, Bot, Database, Rocket } from "lucide-react";

const ACHIEVEMENTS = [
  {
    icon: <Briefcase size={20} />,
    text: "1+ years of professional experience developing enterprise backend systems, REST APIs, and business applications using Laravel, FastAPI, and Django.",
  },
  {
    icon: <Bot size={20} />,
    text: "Built AI-powered products including AI Digital Twin, AI Agents, RAG-based chatbots, and AI Social Media Automation platforms using FastAPI and modern LLM technologies.",
  },
  {
    icon: <Database size={20} />,
    text: "Hands-on experience with PostgreSQL, MySQL, SQLAlchemy, Eloquent ORM, Vector Databases, query optimization, and scalable database design.",
  },
  {
    icon: <Rocket size={20} />,
    text: "Delivered enterprise ERP modules, third-party integrations (SAP, OAuth), authentication systems, and production-ready backend architectures.",
  },
];
    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="sr-hidden sr-d2 mb-12">
          ...
          >
            My academic foundation in Computer Applications, combined with
            hands-on industry experience and continuous learning in backend
            development, enterprise software, and Artificial Intelligence, has
            helped me build scalable applications and modern AI-powered
            solutions.
          </p>
        </div>
