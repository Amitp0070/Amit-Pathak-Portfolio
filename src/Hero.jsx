...
import SwapText from "./anim/SwapText";
import {
  Zap,
  Bot,
  BrainCircuit,
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-4 pb-20 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              Backend Developer with <strong>1+ years</strong> of professional
              experience building enterprise ERP systems, scalable REST APIs,
              and AI-powered applications. Currently developing AI Agents,
              RAG-based solutions, and enterprise backend platforms using
              FastAPI, Laravel, PostgreSQL, React, and modern LLM technologies.
            </p>
            ...
            <div className="reveal-fade delay-600 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              ...
              >
                <SwapText>View My Work →</SwapText>
              </button>
            ...
            <div className="reveal-fade delay-700 flex items-center gap-6 mt-10 justify-center lg:justify-start flex-wrap">
              {[
                ...
                { num: 10, suffix: "+", label: "Production Projects" },
                { num: 3, suffix: "", label: "Enterprise Products" },
              ].map((s, i) => (
                <div
                  key={i}
